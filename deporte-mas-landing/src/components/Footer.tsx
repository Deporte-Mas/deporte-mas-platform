const Footer = () => {
  return (
    <footer className="bg-card py-8 sm:py-12 border-t border-primary/20">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid gap-6 sm:gap-8 text-center sm:text-left sm:grid-cols-2 lg:grid-cols-3">
          {/* Brand */}
          <div className="sm:col-span-2 lg:col-span-1">
            <h3 className="text-xl sm:text-2xl font-headline text-primary mb-4">DEPORTE+ CLUB</h3>
          ...
          {/* Links */}
          <div>
            <h4 className="font-headline text-accent mb-4 text-base sm:text-lg">ENLACES</h4>
            <ul className="space-y-2 font-body text-sm">
              <li>
                <a href="#" className="text-muted-foreground hover:text-primary transition-smooth inline-block py-1">
          ...
          {/* Contact & Social */}
          <div>
            <h4 className="font-headline text-accent mb-4 text-base sm:text-lg">SÍGUENOS</h4>
            <div className="space-y-3 font-body text-sm">
              ...
              <div className="flex justify-center sm:justify-start gap-4 pt-2">
                <a href="#" className="text-muted-foreground hover:text-primary transition-smooth py-1">
                  Facebook
                </a>
                <a href="#" className="text-muted-foreground hover:text-primary transition-smooth py-1">
                  Instagram
